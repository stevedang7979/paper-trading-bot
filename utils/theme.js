const lightTheme = {
  ...
  sidebarBgStart: "var(--color-yellow)",
  sidebarBgEnd: "var(--color-white)",
  ...
  linkText: "var(--color-black)",
  linkBefore: "var(--color-white)",
  linkHover: "var(--color-white)",
  ...
  iconBorder: "var(--color-black)",
  iconStroke: "var(--color-black)",
  iconHoverBg: "var(--color-white)",
  iconHoverBorder: "var(--color-white)",
  iconHoverStroke: "var(--color-white)",
